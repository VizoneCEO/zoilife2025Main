...
<link rel="stylesheet" href="front/general/header.css">
...
<header class="main-header">
    ...
    <a class="logo" href="index.php">
        <img src="front/multimedia/logod.jpeg" alt="Zoilife Logo">
    </a>
                    ...
                    .then(data => {
                        ...
                        if (data.length > 0) {
                            data.forEach(p => {
                                ...
                                item.innerHTML = `
                                <img src="front/productosWeb/${p.foto_principal}" alt="${p.nombre_producto}" style="width:50px; height:50px; object-fit:cover; border-radius:5px; margin-right:10px;">
                                <div>
                            ...
                            `;
                                ...
                                item.onclick = () => {
                                    window.location.href = "front/productos/detalleProducto.php?id=" + p.id_producto_web;
                                };
    ...
    <div class="user-cart">
        <a href="front/auth/login.php" class="user-btn">
...
<nav class="main-nav">
    <ul>
        ...
        <li><a href="front/productos/productos.php">PRODUCTOS</a></li>
        <li><a href="front/blog/blog.php">BLOG</a></li>
